...
Set `$mode` to one of the following modes:
...
- `$clusterNode` - the host name or IP of the cluster node for the IPsec tunnel on the cluster side
- `$externalHost` - the external host name or IP
