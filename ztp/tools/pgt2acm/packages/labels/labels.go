...
// Converts a label list and an exclude label list to a Selector
...
// converts a labe list to a list of requirements in a selector
...
// outputs the Selector as a generic Yaml
