...
So before doing the migration check if the `AgentClusterInstall` that is already on the hub have set any of the above fields. If so there are two options:
