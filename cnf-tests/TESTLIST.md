...
| [performance] RPS configuration [test_id: 59572] Check RPS Mask is applied to at least one single rx queue on all veth interface | Checks that least one single rx queue on all veth interface applied with correct RPS mask | 
