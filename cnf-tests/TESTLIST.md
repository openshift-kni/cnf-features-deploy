...
| Test Name | Description |
| -- | ----------- |
| [performance]  Should have kernel param rcutree.kthread | Verifies that performance profile have kernel parameter rcutree.kthread | 
...
| [performance] Checking IRQBalance settings Verify irqbalance configuration handling Should DO overwrite the banned CPU set on CRI-O restart | Verify irqbalance configuration handling Should DO overwrite the banned CPU set on CRI-O restart | 
| [performance] Checking IRQBalance settings Verify irqbalance configuration handling Should not overwrite the banned CPU set on tuned restart | Verify irqbalance configuration handling Should not overwrite the banned CPU set on tuned restart | 
| [performance] Checking IRQBalance settings Verify irqbalance configuration handling Should store empty cpu mask in the backup file | Verify irqbalance configuration handling Should store empty cpu mask in the backup file | 
...
| [performance] RPS configuration Should not have RPS configuration set when realtime workload hint is explicitly set | RPS configuration Should not have RPS configuration set when realtime workload hint is explicitly set | 
