...
| [performance] Verify API Conversions  when the GloballyDisableIrqLoadBalancing field set to false should preserve the value during the v1 <-> v2 conversion | Verifies that Performance Addon Operator preserve GloballyDisableIrqLoadBalancing field value when it set to false during the v1 <-> v2 API conversion | 
| [performance] Verify API Conversions  when the GloballyDisableIrqLoadBalancing field set to true should preserve the value during the v1 <-> v2 conversion | Verifies that Performance Addon Operator preserve GloballyDisableIrqLoadBalancing field value when it set to true during the v1 <-> v2 API conversion | 
