...
| [performance] CPU Management when reserved CPUs specified  should run infra containers on reserved CPUs | Verifies infra containers run on reserved CPUs when reserved CPUs specified | 
...
| [performance] KubeletConfig experimental annotation should override system-reserved memory | Verifies that KubeletConfig experimental annotation overrides system-reserved memory | 
...
| [performance] Verify containers specifications  imagePullPolicy should be ifNotPresent | Verifies imagePullPolicy of performance pod is ifNotPresent | 
