...
replace (
	...
	github.com/openshift-kni/performance-addon-operators => github.com/openshift-kni/performance-addon-operators v0.0.41002-0.20220907071928-1225edcba6ad // release-4.10
