...
replace (
	...
	github.com/openshift-kni/performance-addon-operators => github.com/openshift-kni/performance-addon-operators v0.0.0-20210617164829-792ee9155c08 // release-4.8
