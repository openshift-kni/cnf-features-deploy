...
require (
	...
	github.com/smart-edge-open/openshift-operator/N3000 v0.0.0-20211130191513-0490a85f4f9a
	github.com/smart-edge-open/openshift-operator/sriov-fec v0.0.0-20211130191513-0490a85f4f9a
...
// Test deps
replace (
	github.com/k8snetworkplumbingwg/sriov-network-operator => github.com/openshift/sriov-network-operator v0.0.0-20220518081304-2aa62eed1e20 // release-4.8
